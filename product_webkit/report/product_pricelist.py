...
report_sxw.report_sxw('report.product.pricelist.webkit','product.product','addons/product_webkit/report/product_pricelist.mako',parser=product_pricelist)
