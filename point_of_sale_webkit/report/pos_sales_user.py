...
report_sxw.report_sxw('report.pos.sales.user.webkit', 'pos.order', 'addons/point_of_sale_webkit/report/pos_sales_user.mako', parser=pos_sales_user,header='internal')
