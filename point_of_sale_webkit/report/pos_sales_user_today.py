...
report_sxw.report_sxw('report.pos.sales.user.today.webkit', 'pos.order', 'addons/point_of_sale_webkit/report/pos_sales_user_today.mako', parser=pos_sales_user_today,header='internal')
